...
class Account(db.Model):
    ...
    CustomerID = db.Column(db.String, db.ForeignKey('Customer.CustomerID'), nullable=False)  # Khóa ngoại
    ...
    customer = db.relationship('Customer', backref='accounts')  # Tạo quan hệ với Customer
...
class CreditScore(db.Model):
    ...
    CustomerID = db.Column(db.String, db.ForeignKey('Customer.CustomerID'),
                           primary_key=True)  # Khóa ngoại và khóa chính
