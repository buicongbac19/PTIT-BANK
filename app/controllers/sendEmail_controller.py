...
# Thông tin chung về cấu hình email
SMTP_SERVER = "smtp.gmail.com"
SMTP_PORT = 587
SENDER_EMAIL = "hhtrinh2505@gmail.com"  # Thay bằng email của bạn
SENDER_PASSWORD = "gslj zyxq baxt ekqg"  # Thay bằng mật khẩu ứng dụng của bạn
