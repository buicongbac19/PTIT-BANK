...
def dashboard():
    ...
    return render_template("admin/admin.html", total_transactions=total_transactions, 
    total_customers=total_customers, total_money=total_money, latest_transactions=latest_transactions)
